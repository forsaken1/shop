<div id = 'registrationModule'>
  ...
  <b>E-mail</b><br>  <input maxlength = 50 name = 'mail' id = 'mail'></input><br>
  ...
  <b>Логин *</b><br>             <input maxlength = 25 id = 'login' name = 'login' onblur = 'checkLogin()'></input><b id = 'checkLogin'></b><br>
  <b>Пароль *</b><br>            <input maxlength = 25 type = 'password' name = 'password' id = 'password' onblur = 'checkPassword()'></input><b id = 'passCheck'></b><br>
  <b>Подтвердите пароль *</b><br><input maxlength = 25 type = 'password' name = 'passwordConf' id = 'passwordConf' onblur = 'checkPasswordConf()'><b id = 'passConfCheck'></b></input><br>
  <input type = 'button' onclick = 'checkAll()' value = 'Зарегистрироваться'></input><b id = 'check'></b><br>
...
<script>			
	...
	function checkAll() {
		if(checkOther() && checkLogin() && checkPassword() && checkPasswordConf()) registration();
	}
